        ...
        methods: {
            ...
            validar(){
                ...
                if(this.nombre.length<1 || this.nombre.length>254){
                    this.validaMensaje.push('El nombre del tipo de mantenimiento debe tener entre 1-254 caracteres');
                }
                if(this.descripcion.length>254){
                    this.validaMensaje.push('La descripcion del tipo de mantenimiento debe tener entre 1-254 caracteres');
                }
            ...
            guardar(){
                ...
                if(this.editedIndex > -1){
                    //Editar registro
                    axios.put(`tipos/tipos_mantenimientos/${this.id}/`, {'id':this.id, 'nombre':this.nombre, 'descripcion':this.descripcion})
                    .then(function(){
                        me.limpiar();
                        me.close();
                        me.listar();                        
                    ...
                    //Guardar registro
                    axios.post('tipos/tipos_mantenimientos/', {'nombre':this.nombre, 'descripcion':this.descripcion})
                    .then(function (){
                        me.limpiar();
                        me.close();
            ...
            deleteItem () {   
                let me = this;               
                axios.delete(`tipos/tipos_mantenimientos/${this.adId}/`)
                .then(function(){                                        
                    me.adModal = false;
                    me.listar();
                })
